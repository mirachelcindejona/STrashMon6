...
void resetData() {
   ...
   while (!kembali) {
      ...
      switch (pilihan) {
         case 1:
            cout << "Konfirmasi reset semua data? (y/n): ";
            cin >> konfirmasi;
            if (konfirmasi == 'y' || konfirmasi == 'Y') {
               resetSemuaData();
            } else {
               cout << "❌ Reset semua dibatalkan.\n";
            }
            break;
         case 2:
            cout << "Konfirmasi reset queue notifikasi? (y/n): ";
            cin >> konfirmasi;
            if (konfirmasi == 'y' || konfirmasi == 'Y') {
               resetQueueData();
            } else {
               cout << "❌ Reset queue dibatalkan.\n";
            }
            break;
         case 3:
            cout << "Konfirmasi reset histori stack? (y/n): ";
            cin >> konfirmasi;
            if (konfirmasi == 'y' || konfirmasi == 'Y') {
               resetHistoryData();
            } else {
               cout << "❌ Reset histori dibatalkan.\n";
            }
            break;
         case 4:
...
void simulasiUpdateSensor() {
   updateSensorLevels();
   updateSemuaHistori();
   simpanHistoriKeFile();
   cout << "Sensor telah diperbarui dan histori tercatat.\n";
   displaySensorStatus();
}
...
void menuUtama() {
   ...
   while (aktif) {
      ...
      cout << "5. Reset data\n";
      cout << "6. Simulasi Update Sensor (1x)\n";
      cout << "0. Keluar\n";
      cout << "Pilih menu: ";
